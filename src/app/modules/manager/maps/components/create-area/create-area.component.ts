...
@Component({
	...
	template: ` <div class="modal fade" id="createAreaModal" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="createAreaModalLabel" aria-hidden="true">
