...
@Component({
	...
	template: `
		...
		<!-- Dos columnas que fluyen de forma independiente (flex-column + gap) en vez de 3 filas
			 emparejadas por altura — con filas, la sección más corta de cada fila (ej. Logo vs. Color
			 de acento) quedaba con un hueco vacío hasta que la más alta de esa fila terminaba, antes
			 de que arrancara la siguiente (bug real reportado: "que no quede tanto espacio vacío"). -->
