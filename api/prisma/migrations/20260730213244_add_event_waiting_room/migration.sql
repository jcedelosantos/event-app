...
INSERT INTO "new_Event" ("active", "checkInWindowHours", "code", "createdAt", "dateOff", "dateOn", "dateSale", "description", "duplicateGroupKey", "hostName", "id", "img", "mapId", "maxHostGuests", "name", "paymentMode", "publishAt", "startTime", "tenantId", "type", "updatedAt", "userId") SELECT "active", "checkInWindowHours", "code", "createdAt", "dateOff", "dateOn", "dateSale", "description", "duplicateGroupKey", "hostName", "id", "img", "mapId", "maxHostGuests", "name", "paymentMode", "publishAt", "startTime", "tenantId", "type", "updatedAt", "userId" FROM "Event";
DROP TABLE "Event";
